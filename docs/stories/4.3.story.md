...
-   [ ] 태그 데이터 모델 및 스키마 구현 (AC: 6)

    -   [ ] tags 테이블 스키마 정의
    -   [ ] note_tags 연결 테이블 스키마 정의
    -   [ ] Drizzle 스키마 파일 생성
    -   [ ] 마이그레이션 파일 생성
    -   [ ] 타입 정의 추가

-   [ ] Gemini API 태그 생성 서비스 구현 (AC: 2, 9, 10)
...
-   [ ] 태그 생성 Server Action 구현 (AC: 5, 6, 8)

    -   [ ] generateTags Server Action
    -   [ ] 에러 핸들링 로직
    -   [ ] 데이터베이스 저장 로직
    -   [ ] 사용자 권한 검증

-   [ ] 노트 상세 페이지 UI 업데이트 (AC: 1, 3, 4, 7, 11)
